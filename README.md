...
Analista de Dados com experiência em transformar dados dispersos em informações confiáveis para tomada de decisão.

- 🔍 Foco em **SQL**, **Power BI** e **Python para análise de dados**
- 📊 Experiência com dashboards, ETL e modelagem de dados
- 🎓 Cursando Engenharia de Dados (UNICV)
- 📜 Certificado Google Data Analytics
- 🚀 Projetos práticos com foco em problemas reais de negócio
...
| 🔗 [Pizzaria Jablonsk](https://github.com/natoawayrj/pizzaria-jablonsk) | Sistema de pedidos end-to-end de uma pizzaria, usado como **fonte de dados (OLTP) real** para um projeto de dados. Banco modelado do zero (clientes, pedidos, itens, sabores, cupons, avaliações) com pipeline ETL e camada analítica em construção (modelo dimensional + dashboard de BI) | Python, Flask, SQLite, SQL |
